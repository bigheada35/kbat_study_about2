...
-->
		...
		<sec:authorize access="isAnonymous()">
          ...
          <sec:authorize access="isAuthenticated()">
			<li><a href="#" style="color:gray;"><sec:authentication property="principal.user.member_id"/>님</a>
			<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdown07XL" data-toggle="dropdown" aria-expanded="false"></a>
          <div class="dropdown-menu" aria-labelledby="dropdown07XL">
            <a class="dropdown-item" href="/logout">logout</a>
            <a class="dropdown-item" href="/index">index</a>
            <a class="dropdown-item" href="/add/addForm">회원가입</a>
