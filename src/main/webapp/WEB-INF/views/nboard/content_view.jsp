...
<body>
	...
	<table width="500" cellpadding="0" cellspacing="0" border="1">
		<form:form action="nmodify_view" method="post">
			...
			<input type="hidden" name="board_hit"
				value="${content_view.board_hit}">
			<input type="hidden" name="board_title"
				value="${content_view.board_title}">
			...
			<tr>
				...
				<td colspan="2"><a href="nlist">목록</a> &nbsp;&nbsp; <a
					href="nmodify_view?board_id=${content_view.board_id}">수정</a>
